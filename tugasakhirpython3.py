...
def home():
    ...
    if (pilihan_menu == 1):
        ...
        row = input('Data yang ingin dihapus (masukkan nomor baris):')
        hapus_data(int(row)-1,judul)
        #print (show_data())
    elif (pilihan_menu == 4):
        print ('Terimakasih sudah menggunakan aplikasi')
        print ("Laut Maluku Indah tempat pancing ikan layur, Yuk kita makan buah dan sayur")
...
def daftar_menu():
    print('==================================')
    print ('Menu Gudang Sayur dan Buah')
    print('==================================')
